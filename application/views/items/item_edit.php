    ...
    <div class="row no-gutters">
        ...
        <div class="col-sm-12 col-md-4 col-lg-4 p-2">
            ...
            <input type="text" name="name" class="form-control" value="<?php echo $item['name']; ?>"
                placeholder="Unesit naziv proizvoda">
        </div>
        <div class="col-sm-12 col-md-4 col-lg-4 p-2">
            <label>Kod proizvoda</label>
            <?php  if(form_error('code')) echo '<div class="alert alert-warning">' . form_error('code'). '</div>'; ?>
            <input type="text" name="code" class="form-control" placeholder="Unesit kod proizvoda"
        ...
        <div class="col-sm-12 col-md-4 col-lg-4 p-2">
            ...
            <input type="text" name="mes-unit" class="form-control" placeholder="kom ili rs"
                value="<?php echo $item['mes_unit']; ?>">
        </div>
        <div class="col-sm-12 col-md-4 col-lg-4 p-2">
            <label>PDV</label>
            <?php  if(form_error('tax')) echo '<div class="alert alert-warning">' . form_error('tax'). '</div>'; ?>
            <input type="text" name="tax" class="form-control" placeholder="Unesite pdv za proizvod"
                value="<?php echo $item['tax']; ?>">
        </div>
        <div class="col-sm-12 col-md-4 col-lg-4 p-2">
            <label>Količina</label>
            <?php  if(form_error('quantity')) echo '<div class="alert alert-warning">' . form_error('quantity'). '</div>'; ?>
            <input type="text" name="quantity" class="form-control" placeholder="Unesite količinu proizvoda"
        ...
        <div class="col-sm-12 col-md-4 col-lg-4 p-2">
            ...
            <input type="text" name="buying-price" class="form-control" placeholder="Unesite kupovnu cenu za proizvod"
                value="<?php echo $item['buying_price']; ?>">
        </div>
        <div class="col-sm-12 col-md-4 col-lg-4 p-2">
            <label>Prodajna cena</label>
            <?php  if(form_error('selling-price')) echo '<div class="alert alert-warning">' . form_error('selling-price'). '</div>'; ?>
            <input type="text" name="selling-price" class="form-control" placeholder="Unesite prodajnu cenu za proizvod"
        ...
        <div class="col-sm-12 col-md-4 col-lg-4 p-2">
            ...
            <input type="text" name="sellers-code" class="form-control" placeholder="Unesite kod prodavca za proizvod"
                value="<?php echo $item['sellers_code']; ?>">
        </div>
        <div class="col-sm-12 col-md-4 col-lg-4 p-2">
            ...
            <input type="text" name="sellers-name" class="form-control"
                placeholder="Unesite naziv kod prodavza za proizvod" value="<?php echo $item['sellers_name']; ?>">
        </div>
        <div class="col-sm-12 col-md-4 col-lg-4 p-2">
            <label>Opis</label>
            <?php  if(form_error('description')) echo '<div class="alert alert-warning">' . form_error('description'). '</div>'; ?>
            <textarea rows="4" cols="20" type="text" name="description" class="form-control"
                placeholder="Unesite opis za proizvod" value=""><?php echo $item['description']; ?></textarea>
        </div>
