...
<div class="article container">
    <div class="table-responsive">
        <div class="search">
            ...
            <form><label for="hint-inp">Unesi naziv</label> <input id="hint-inp" type="text"
        ...
        <table class="table table-striped">
            ...
            ;?>
                    ...
                    <td><button class="edit-item" type="submit" title="Izmeni"><a
                                href="<?php echo base_url(); ?>items/edit/<?php echo $value['id']; ?>"
                                class="btn-default"><i class="fas fa-pen"></i></a></button></td>
                    <td><button class="delete-item" type="submit" title="Obriši"><a
                                href="<?php echo base_url(); ?>items/delete/<?php echo $value['id']; ?>"><i
