...
<div class="row no-gutters">
    ...
    <div class="col-sm-12 col-md-4 m-auto">
        ...
        <div class="form-inline my-1">
            ...
            <input type="text" name="name" placeholder="Korisničko ime" class="form-control" required  autofocus  oninvalid="this.setCustomValidity('Obavezno polje')"
    oninput="this.setCustomValidity('')">
        </div>
        <div class="form-inline my-1">

            <input type="password" name="password" placeholder="Šifra" class="form-control" required autofocus  oninvalid="this.setCustomValidity('Obavezno polje')"
    oninput="this.setCustomValidity('')">
        </div>
