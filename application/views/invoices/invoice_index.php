<script>
    function confirmAction(id, object) {
        if (confirm("Da li želite obrisati fakturu!")) {
            window.location = '<?php echo base_url(); ?>invoices/delete/' + id;
        } else {}
    }
</script>
            ...
            <tbody>
                <?php foreach ($invoices as $key => $value) : ?>
                    ...
                    <tr>
                        ...
                        <?php $date = date_create($value['pay_deadline']);
                        $dateformat = date_format($date, "d.m.Y."); ?>
                        <td><?php echo $dateformat; ?></td>
                        <td class="number"><?php echo $value['total']; ?></td>
                        <td class="number"><?php echo $value['payed']; ?></td>
                        <td class="number"><?php echo $value['due']; ?></td>
                        <td><button class="edit-item" type="submit" title="Izmeni"><a href="<?php echo base_url(); ?>invoices/view/<?php echo $value['id']; ?>" class="btn-default"><i class="fas fa-pen"></i></a></button></td>
