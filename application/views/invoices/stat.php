<div class="create-header">
    <h2>Statistika fakture</h2>
</div>
<div class="container create-wrapper mt-0 mb-2">
    <?php echo form_open('invoices/get_stat'); ?>
    <div class="row no-gutters">
        <div class="col-sm-12 col-md-4 col-lg-4 p-2">
            <label>Datum od</label>
            <input type="text" id="date-from" name="date-from" class="form-control" value="<?php echo set_value('date-from', ''); ?>" placeholder="Fakture izdane od ovog datum">
        </div>

        <div class="col-sm-12 col-md-4 col-lg-4 p-2">
            <label>Datum do</label>
            <input type="text" id="date-to" name="date-to" class="form-control" value="<?php echo set_value('date-to', ''); ?>" placeholder="Fakture izdane do ovog datuma">
        </div>

        <div class="col-sm-12 col-md-4 col-lg-4 p-2">
            <label>Rok za plaćanje</label>
            <input type="text" id="pay-deadline" name="pay-deadline" class="form-control" placeholder="Do ovog datuma" value="<?php echo set_value('pay-deadline', ''); ?>">
        </div>
